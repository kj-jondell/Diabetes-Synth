...
QT_MOC_LITERAL(1, 13, 8), // "fileOpen"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "CApplication\0fileOpen\0"
};
...
void CApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CApplication *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CApplication::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CApplication::fileOpen)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CApplication::staticMetaObject = { {
    QMetaObject::SuperData::link<QApplication::staticMetaObject>(),
    qt_meta_stringdata_CApplication.data,
    qt_meta_data_CApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CApplication::fileOpen(QString _t1)
{
